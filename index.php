...
<div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <div class="client-description">
            <p class="text-center">
                ... Commerçant, artisan, jeune entrepreneur.... Vous voulez vous faire connaitre sur le Web ? Augmenter votre chiffre d'affaire ? Trouvez de nouveaux clients ?! Un site web est l'idéal ! Peut importe votre secteur d'activité, il y à toujours une réponse à votre besoin.
            </p>
        </div>
    </div>
</div>
